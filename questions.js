const questionBank = [
    ...
    // --- 20 NEW MIXED DOMAIN QUESTIONS ---

    // -- ALGEBRA & EQUATIONS --
    {
        domain: "Equations & Expressions", difficulty: "Easy", type: "msq", std: "A-SSE.1", 
        text: "In the expression \\( 4x^2 - 3x + 7 \\), what is the coefficient of the linear term?", 
        options: ["4", "2", "-3", "7"], 
        correctIndices: [2], 
        hint: "The 'linear term' is the one with just a plain 'x' (no exponent). The coefficient is the number attached to it.", 
        desmosHint: null, 
        explanation: "The linear term is \\( -3x \\). The coefficient (the number in front) is -3."
    },
    {
        domain: "Equations & Expressions", difficulty: "Medium", type: "text", std: "A-REI.11", 
        text: "If \\( f(x) = 2x - 4 \\) and \\( g(x) = -x + 5 \\), at what exact x-value does \\( f(x) = g(x) \\)?", 
        correctText: "3", 
        hint: "Set them equal to each other: \\( 2x - 4 = -x + 5 \\) and solve for x.", 
        desmosHint: "**Desmos EOC Trick:** Graph `y = 2x - 4` on line 1 and `y = -x + 5` on line 2. Click where they intersect. The x-coordinate is your answer!", 
        explanation: "Add x to both sides: \\( 3x - 4 = 5 \\). Add 4 to both sides: \\( 3x = 9 \\). Divide by 3: \\( x = 3 \\)."
    },
    {
        domain: "Equations & Expressions", difficulty: "Hard", type: "sata", std: "A-REI.12", 
        text: "Which of the following points are in the solution set for the system of inequalities?<br><br>\\( y \\ge 2x - 1 \\)<br>\\( y < -x + 4 \\)", 
        options: ["(0, 0)", "(1, 1)", "(2, 5)", "(-2, 3)"], 
        correctIndices: [0, 1], 
        hint: "A point must make BOTH inequalities true to be a solution.", 
        desmosHint: "**Desmos EOC Trick:** Type both inequalities into Desmos. Look for the 'double-shaded' region. Graph all four points and see which ones land inside that double-shaded area!", 
        explanation: "Plugging in (0,0): \\( 0 \\ge -1 \\) (True) and \\( 0 < 4 \\) (True). Plugging in (1,1): \\( 1 \\ge 1 \\) (True) and \\( 1 < 3 \\) (True). The others fail at least one inequality."
    },
    {
        domain: "Equations & Expressions", difficulty: "Medium", type: "msq", std: "A-CED.1", 
        text: "A gym charges a $30 sign-up fee and $15 per month. Which equation represents the total cost, \\( C \\), for \\( m \\) months?", 
        options: ["\\( C = 30m + 15 \\)", "\\( C = 15m + 30 \\)", "\\( C = 45m \\)", "\\( C = 15(m + 30) \\)"], 
        correctIndices: [1], 
        hint: "The monthly rate is the slope (attached to the variable), and the one-time fee is the y-intercept.", 
        desmosHint: null, 
        explanation: "$15 happens every month, so it multiplies by \\( m \\). The $30 is a one-time flat fee. The equation is \\( C = 15m + 30 \\)."
    },
    {
        domain: "Equations & Expressions", difficulty: "Medium", type: "dropdown", std: "N-RN.2", 
        text: "The expression \\( (x^3)^4 \\) simplifies to \\( x \\) to the power of [DROP], while \\( x^3 \\cdot x^4 \\) simplifies to \\( x \\) to the power of [DROP].", 
        options: [["7", "12", "81"], ["7", "12", "81"]], 
        correctIndices: [1, 0], 
        hint: "Power to a power means multiply. Multiplying bases means add the exponents.", 
        desmosHint: "**Desmos EOC Trick:** Set `x=2`. Type `(x^3)^4` and see the result. Then test `x^7` and `x^12` to see which matches!", 
        explanation: "When you raise an exponent to another exponent, you multiply (3 * 4 = 12). When you multiply matching bases, you add the exponents (3 + 4 = 7)."
    },
    {
        domain: "Equations & Expressions", difficulty: "Hard", type: "msq", std: "A-CED.2", 
        text: "A sequence is defined by \\( a_1 = 4 \\) and \\( a_n = a_{n-1} + 7 \\). What is the 5th term in the sequence?", 
        options: ["25", "28", "32", "35"], 
        correctIndices: [2], 
        hint: "This is a recursive formula. It means 'start at 4, and add 7 each time.' Just do it 4 more times!", 
        desmosHint: null, 
        explanation: "Term 1: 4. Term 2: 11. Term 3: 18. Term 4: 25. Term 5: 32."
    },

    // -- FUNCTIONS --
    {
        domain: "Functions", difficulty: "Easy", type: "msq", std: "F-IF.1", 
        text: "Which of the following relationships does NOT represent a function?", 
        options: ["\\( (1,2), (2,3), (3,4) \\)", "\\( (1,5), (2,5), (3,5) \\)", "\\( (1,2), (1,3), (2,4) \\)", "\\( (0,0), (1,1), (-1,1) \\)"], 
        correctIndices: [2], 
        hint: "In a function, every x-value can only have ONE y-value. Look for repeating x-coordinates.", 
        desmosHint: null, 
        explanation: "The x-coordinate '1' is paired with both '2' and '3'. Because the input of 1 gives two different outputs, it fails the definition of a function (and the vertical line test)."
    },
    {
        domain: "Functions", difficulty: "Medium", type: "sata", std: "F-IF.7", 
        text: "Which of the following are true about the absolute value function \\( f(x) = |x - 2| + 3 \\)?", 
        options: ["The vertex is at (-2, 3)", "The vertex is at (2, 3)", "The graph opens in a V-shape upwards", "The y-intercept is at (0, 3)"], 
        correctIndices: [1, 2], 
        hint: "Absolute value graphs are V-shaped. The vertex is (h, k), but remember the inside sign is opposite.", 
        desmosHint: "**Desmos EOC Trick:** Graph `y = |x - 2| + 3` (you can type 'abs' or use the absolute value bars). Click the lowest point to find the vertex, and click the y-axis to find the intercept.", 
        explanation: "The vertex is (2, 3). The positive sign in front means it opens upwards. Plugging in x=0 gives \\( |-2| + 3 = 2 + 3 = 5 \\), so the y-intercept is 5, not 3."
    },
    {
        domain: "Functions", difficulty: "Hard", type: "dropdown", std: "F-LE.3", 
        text: "Function A is \\( y = 50x + 100 \\). Function B is \\( y = 2^x \\). As \\( x \\) gets extremely large, Function [DROP] will eventually exceed Function [DROP] because [DROP] growth always outpaces linear growth.", 
        options: [["A", "B"], ["A", "B"], ["exponential", "quadratic"]], 
        correctIndices: [1, 0, 0], 
        hint: "Exponentials start slow but explode in value. Lines just plod along at the same steady rate.", 
        desmosHint: "**Desmos EOC Trick:** Graph both. Zoom way, way out. You will see the curve eventually shoot straight past the straight line.", 
        explanation: "Function B is exponential (the variable is in the exponent). Function A is linear. An exponential function will ALWAYS eventually outgrow a linear or polynomial function."
    },
    {
        domain: "Functions", difficulty: "Medium", type: "text", std: "F-IF.4", 
        text: "A ball is thrown in the air. Its height is modeled by \\( h(t) = -16t^2 + 64t + 80 \\). At what time \\( t \\) does the ball hit the ground?", 
        correctText: "5", 
        hint: "Hitting the ground means the height is 0. Set the equation to 0 and solve for the positive x-intercept.", 
        desmosHint: "**Desmos EOC Trick:** Change 't' to 'x'. Graph the equation. The 'ground' is the horizontal x-axis. Click the positive x-intercept!", 
        explanation: "Setting to 0 and factoring out -16 gives \\( -16(t^2 - 4t - 5) = 0 \\). Factoring further gives \\( -16(t - 5)(t + 1) = 0 \\). Time cannot be negative, so \\( t = 5 \\)."
    },
    {
        domain: "Functions", difficulty: "Easy", type: "msq", std: "F-IF.9", 
        text: "Function 1 has a slope of 3. Function 2 passes through the points (0, 4) and (2, 12). Which function has a steeper rate of change?", 
        options: ["Function 1", "Function 2", "They have the same rate of change", "Cannot be determined"], 
        correctIndices: [1], 
        hint: "Calculate the slope of Function 2 using \\( (y_2 - y_1) / (x_2 - x_1) \\). Which number is bigger?", 
        desmosHint: null, 
        explanation: "Function 2 slope: \\( (12 - 4) / (2 - 0) = 8 / 2 = 4 \\). Since 4 is greater than 3, Function 2 is steeper."
    },
    {
        domain: "Functions", difficulty: "Medium", type: "dropdown", std: "F-IF.5", 
        text: "The function \\( A(s) = s^2 \\) models the area of a square with side length \\( s \\). The most appropriate domain for this function is all [DROP] numbers, because a side length cannot be [DROP].", 
        options: [["real", "positive real", "integer"], ["a decimal", "negative", "zero"]], 
        correctIndices: [1, 1], 
        hint: "Think about the real world. Can a square have a side length of -4 inches? Can it have a side length of 2.5 inches?", 
        desmosHint: null, 
        explanation: "In the real world, physical lengths must be positive numbers. They can be decimals, so 'integers' is too restrictive. Thus, positive real numbers."
    },
    {
        domain: "Functions", difficulty: "Hard", type: "msq", std: "F-BF.1", 
        text: "A swimming pool has 500 gallons of water and is being filled at a rate of 20 gallons per minute. Which function models the volume of the pool over \\( m \\) minutes?", 
        options: ["\\( V(m) = 500m + 20 \\)", "\\( V(m) = 20m + 500 \\)", "\\( V(m) = 500(20)^m \\)", "\\( V(m) = 20(500)^m \\)"], 
        correctIndices: [1], 
        hint: "The starting amount is the y-intercept. The changing amount (per minute) is the slope.", 
        desmosHint: null, 
        explanation: "The pool starts with 500 (constant) and adds 20 for every minute \\( m \\). This is a linear relationship: \\( 20m + 500 \\)."
    },

    // -- STATISTICS --
    {
        domain: "Statistics", difficulty: "Easy", type: "msq", std: "S-ID.2", 
        text: "If you add 5 to every single number in a data set, what happens to the mean?", 
        options: ["It stays the same", "It increases by 5", "It gets multiplied by 5", "You cannot determine without the data"], 
        correctIndices: [1], 
        hint: "If everyone in the class gets exactly 5 bonus points, what happens to the class average?", 
        desmosHint: "**Desmos EOC Trick:** Test it! Type `mean([1,2,3])`. Then type `mean([6,7,8])`. See what changed.", 
        explanation: "Shifting every data point up by 5 simply shifts the center (the mean) up by exactly 5 as well."
    },
    {
        domain: "Statistics", difficulty: "Medium", type: "sata", std: "S-ID.3", 
        text: "Which of the following statistical measures are heavily affected by extreme outliers?", 
        options: ["Mean", "Median", "Standard Deviation", "Interquartile Range (IQR)"], 
        correctIndices: [0, 2], 
        hint: "Outliers pull averages and spread, but the physical 'middle' of a sorted line doesn't care about the extremes.", 
        desmosHint: null, 
        explanation: "The mean is pulled toward the outlier. The standard deviation gets larger because the data is more spread out. The median and IQR are 'resistant' to outliers."
    },
    {
        domain: "Statistics", difficulty: "Medium", type: "text", std: "S-ID.7", 
        text: "A scatter plot relates hours studied (x) to test scores (y). The line of best fit is \\( y = 4.5x + 60 \\). What score would you predict for a student who studies for 0 hours?", 
        correctText: "60", 
        hint: "If x is 0, what is y?", 
        desmosHint: "**Desmos EOC Trick:** Type `y = 4.5(0) + 60`.", 
        explanation: "The y-intercept represents the starting value when the input (x) is zero. Plugging in 0 leaves you with just 60."
    },
    {
        domain: "Statistics", difficulty: "Hard", type: "dropdown", std: "S-ID.8", 
        text: "A calculator gives a correlation coefficient of \\( r = -0.95 \\). This indicates a [DROP] and [DROP] relationship between the variables.", 
        options: [["strong", "weak"], ["positive", "negative"]], 
        correctIndices: [0, 1], 
        hint: "The sign (+ or -) tells you the direction. How close the number is to 1 or -1 tells you the strength.", 
        desmosHint: null, 
        explanation: "Because it is close to -1, it is very strong. Because it has a minus sign, it is negative."
    },
    {
        domain: "Statistics", difficulty: "Medium", type: "msq", std: "S-ID.5", 
        text: "Out of 200 students, 120 are upperclassmen. Out of those 120 upperclassmen, 80 drive to school. What is the conditional relative frequency of driving to school, given the student is an upperclassman?", 
        options: ["80/200", "120/200", "80/120", "40/120"], 
        correctIndices: [2], 
        hint: "The word 'given' tells you exactly what your denominator should be. Ignore the 200 completely.", 
        desmosHint: null, 
        explanation: "Because you are GIVEN they are an upperclassman, your total pool is only 120. 80 of those drive, so it's 80/120."
    },
    {
        domain: "Statistics", difficulty: "Medium", type: "text", std: "S-ID.1", 
        text: "What is the range of this data set: 14, 21, 8, 33, 19, 25?", 
        correctText: "25", 
        hint: "Range is the maximum value minus the minimum value.", 
        desmosHint: "**Desmos EOC Trick:** You can literally just subtract the highest and lowest numbers in Desmos to be safe.", 
        explanation: "The maximum is 33. The minimum is 8. \\( 33 - 8 = 25 \\)."
    },
    {
        domain: "Statistics", difficulty: "Hard", type: "msq", std: "S-ID.6", 
        text: "You calculate a line of best fit for a scatter plot. You then plot the residuals. The residual points are randomly scattered above and below the zero line with no clear pattern. What does this mean?", 
        options: ["You made a math mistake.", "A linear model is a good fit for the data.", "A linear model is a bad fit; you should use a quadratic.", "The data has a correlation coefficient of zero."], 
        correctIndices: [1], 
        hint: "Randomness in a residual plot is exactly what you want to see!", 
        desmosHint: null, 
        explanation: "If a residual plot shows random scatter (no U-shapes or curves), it confirms that a linear line is the most appropriate model to use."
    },
    ...
    { 
        ...
        type: "text", 
        std: "S-ID.6", 
        text: "A factory machine produces metal gears. A quality control inspector tracks the machine's running time (in hours) and the number of defective gears produced. The line of best fit for the data is \\( y = 3.2x + 1.5 \\). On Tuesday, the machine ran for 8 hours and produced exactly 25 defective gears. What is the residual value for Tuesday? (Type number only)", 
        correctText: "-2.1", 
        hint: "Residual = Actual Value minus Predicted Value. Plug 8 into the equation to get the prediction, then subtract that from the actual 25.", 
        desmosHint: "**Desmos EOC Trick:** Calculate the prediction: `3.2(8) + 1.5`. Note the answer. Then subtract that from 25.", 
        explanation: "Predicted: \\( 3.2(8) + 1.5 = 25.6 + 1.5 = 27.1 \\). Actual: 25. Residual: \\( 25 - 27.1 = -2.1 \\)." 
    },
    { 
        domain: "Equations & Expressions", 
        difficulty: "Medium", 
